...
let lateral=document.getElementById(
"carritoLateral"
);

if(!lateral) return;

lateral.classList.toggle(
"activo"
);

if(
lateral.classList.contains(
"activo"
)
){
...
formPersonalizado.addEventListener(
"submit",
function(e){
...
precio:
parseInt(
productoSeleccionado.dataset.precio
),
...
/* escuchar clic en cualquier imagen del catálogo */
